...
const Profile = () => {
    ...
    const handleChangeProfilePicture = () => {
        Alert.alert('Change Profile Picture', 'This feature is coming soon.'); // Implement this feature
    };

    const handleShowProfilePicture = () => {
        Alert.alert('Show Profile Picture', 'This feature is coming soon.'); // Implement this feature
    };
